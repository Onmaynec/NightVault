...
Исправления после тестов: микрофон, UI actions, E2EE Recovery controls, баннер профиля, фон чата, glass blur, partial render контактов, WAV playback и документация передачи проекта.
