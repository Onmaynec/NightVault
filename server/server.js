...
app.put(
  ...
  asyncRoute(async (req, res) => {
    ...
    recordSyncEvent("create", "message", message.id, chat.id, { message: safeMessage(message) });
    await save({ immediate: true });
...
// NightVault 1.2.0 Mega Release: notes, links and tester diagnostics endpoints
...
// NightVault 1.3.3: E2EE trust, debug report, notifications, search, media and group governance.
...
module.exports = { app, server, listenWithPortFallback };
