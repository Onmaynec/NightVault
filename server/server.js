...
// NightVault 1.3.8 — maintenance mode and server metrics for Admin Pro.
app.use((req, res, next) => {
...
// NightVault 1.3.8 Admin Pro & Server Control Update: notes, links and tester diagnostics endpoints
