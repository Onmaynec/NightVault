...
ok("package version is semver 1.3.9", pkg.version === "1.3.9", pkg.version);
ok("release label is 1.3.9", renderer.includes('const RELEASE_LABEL = "1.3.9"') && renderer.includes("NightVault 1.3.9"));
...
console.log("NightVault 1.3.9 release-audit passed.");
