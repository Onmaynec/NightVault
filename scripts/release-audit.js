...
ok("package version is semver 1.3.8", pkg.version === "1.3.8", pkg.version);
ok("release label is 1.3.8", renderer.includes('const RELEASE_LABEL = "1.3.8"') && renderer.includes("NightVault 1.3.8"));
...
console.log("NightVault 1.3.8 release-audit passed.");
