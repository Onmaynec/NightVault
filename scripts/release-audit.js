...
ok("package version is semver 1.3.7", pkg.version === "1.3.7", pkg.version);
ok("release label is 1.3.7", renderer.includes('const RELEASE_LABEL = "1.3.7"') && renderer.includes("NightVault 1.3.7"));
...
console.log("NightVault 1.3.7 release-audit passed.");
