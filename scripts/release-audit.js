...
ok("package version is semver 1.4.1", pkg.version === "1.4.1", pkg.version);
ok("release label is 1.4.1", renderer.includes('const RELEASE_LABEL = "1.4.1"') && renderer.includes("NightVault 1.4.1"));
...
console.log("NightVault 1.4.1 release-audit passed.");
