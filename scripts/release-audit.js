...
ok("package version is semver 1.4.4", pkg.version === "1.4.4", pkg.version);
ok("release label is 1.4.4", renderer.includes('const RELEASE_LABEL = "1.4.4"') && renderer.includes("NightVault 1.4.4"));
...
console.log("NightVault 1.4.4 release-audit passed.");
