...
ok("package version is semver 1.4.2", pkg.version === "1.4.2", pkg.version);
ok("release label is 1.4.2", renderer.includes('const RELEASE_LABEL = "1.4.2"') && renderer.includes("NightVault 1.4.2"));
...
console.log("NightVault 1.4.2 release-audit passed.");
