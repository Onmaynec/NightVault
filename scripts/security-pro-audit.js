...
const fs = require('fs');
const checks = [
  ['package version 1.4.3', () => require('../package.json').version === '1.4.3'],
  ...
  ['changelog has 1.4.3 items', () => fs.readFileSync('assets/changelog.json','utf8').includes('Security & Messenger Pro Update')],
];
let ok = true;
