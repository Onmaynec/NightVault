...
const fs = require('fs');
const checks = [
  ['package version 1.4.4', () => require('../package.json').version === '1.4.4'],
  ...
  ['changelog has 1.4.4 items', () => fs.readFileSync('assets/changelog.json','utf8').includes('Bugfix & Render Stability Update')],
];
let ok = true;
