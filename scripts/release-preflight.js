...
ok('package semver 1.4.3', pkg.version === '1.4.3', pkg.version);
ok('ui version 1.4.3', renderer.includes('1.4.3'));
ok('admin version 1.4.3', admin.includes('1.4.3'));
ok('changelog has 1.4.3', changelog.includes('"1.4.3"') && changelog.includes('Real UX'));
ok('tag shape documented', read('RELEASE_GUIDE.md').includes('v1.4.3') || read('RELEASE_GUIDE.md').includes('vX.X.X'));
...
console.log('NightVault 1.4.3 release preflight passed.');
