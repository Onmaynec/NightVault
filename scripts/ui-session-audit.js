...
check("version semver 1.3.9", pkg.version === "1.3.9");
check("release label 1.3.9", renderer.includes('const RELEASE_LABEL = "1.3.9"'));
...
check("release history cleanup script output", fs.existsSync(path.join(root, "release-history", "read_version1.3.9RELEASE.md")));
