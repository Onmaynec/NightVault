...
check("version semver 1.3.5", pkg.version === "1.3.5");
check("release label 1.3.5", renderer.includes('const RELEASE_LABEL = "1.3.5"'));
...
check("release history cleanup script output", fs.existsSync(path.join(root, "release-history", "read_version1.3.5RELEASE.md")));
