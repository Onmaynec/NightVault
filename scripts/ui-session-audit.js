...
check("version semver 1.4.3", pkg.version === "1.4.3");
check("release label 1.4.3", renderer.includes('const RELEASE_LABEL = "1.4.3"'));
...
check("release history cleanup script output", fs.existsSync(path.join(root, "release-history", "read_version1.4.3RELEASE.md")));
