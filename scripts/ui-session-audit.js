...
check("version semver 1.3.6", pkg.version === "1.3.6");
check("release label 1.3.6", renderer.includes('const RELEASE_LABEL = "1.3.6"'));
...
check("release history cleanup script output", fs.existsSync(path.join(root, "release-history", "read_version1.3.6RELEASE.md")));
