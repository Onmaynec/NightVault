...
ok("version_1_4_0", pkg.version === "1.4.3", pkg.version);
...
ok("admin_dashboard", admin.includes("renderDashboard") && admin.includes("Dashboard"));
ok("admin_extended_tests", admin.includes("websocket") && admin.includes("Test Center 2.0"));
ok("css_overlay", css.includes("NightVault 1.4.3") || css.includes("voiceBubbleNV137"));
