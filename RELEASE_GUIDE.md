...
## NightVault 1.4.3 release assets checklist

В релизе `v1.4.3` должны быть:

- `NightVault-Setup-1.4.3.exe`
- `NightVault-Setup-1.4.3.exe.blockmap`
- `NightVault-1.4.3-x64.exe`
- `latest.yml`
