# NightVault Backup / Restore

Backup Manager 2.0 использует `.nvbackup` package v2: manifest, database, uploads, safe config и checksum.
Перед импортом создаётся safety backup текущих данных.
