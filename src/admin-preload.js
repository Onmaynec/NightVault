...
contextBridge.exposeInMainWorld("nvAdmin", {
  ...
  importPreview: () => ipcRenderer.invoke("admin-import-preview"),
  openDataDir: () => ipcRenderer.invoke("admin-open-data-dir"),
  releasePreflight: () => ipcRenderer.invoke("admin-release-preflight"),
